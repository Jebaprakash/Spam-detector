...
st.markdown(
    ...
    <style>
        ...
        .verdict-spam {
            background: #fdecea; border-left: 5px solid #e53935;
...
with col_info:
    st.markdown("#### About Spade")
    st.info(
        "Spade uses an **ensemble of 5 ML classifiers** trained on ~18,000 "
        "labelled emails. Each model votes independently; the majority verdict "
        "is the final result.\n\n"
        "**Ensemble accuracy: 99.0%**\n\n"
        "Models: Naive Bayes · Logistic Regression · Random Forest · KNN · SVM\n\n"
        "Language model: **TF-IDF** (outperforms Bag-of-Words on all classifiers)"
    )
